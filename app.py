...
from utils import draw_point_marker, mask_painter, images_to_mp4, DAVIS_PALETTE, gpu_profile
...
def on_4d_generation(video_path: str):
    raise gr.Error(
        "4D generation has moved to scripts/run_4d_from_cache.py. "
        "Please export a SAM3 cache and run 4D offline."
    )
